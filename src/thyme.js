        ...
        <View style={{flex:1,marginTop:23,backgroundColor:'#E0E0E0'}}>
            <View style={styles.header}>
                <Icon
                    ...
                    color='#ffffff'
                    size={32} />
                <Text style={{paddingLeft:65,fontSize:20,color:'#ffffff'}}>THYME SQUARE CAFE</Text>
                <View style={{alignItems:'flex-end',paddingLeft:70}}>
                <Icon
                    containerStyle={{alignItems: 'flex-end',marginLeft:400}}
